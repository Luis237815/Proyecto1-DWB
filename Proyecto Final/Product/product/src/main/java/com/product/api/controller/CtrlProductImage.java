...
public class CtrlProductImage {
    ...
    public ResponseEntity<ApiResponse> uploadProductImage(@Valid @RequestBody ProductImage productImage, BindingResult bindingResult){
        ...
        return new ResponseEntity<>(svc.createProductImage(productImage), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ApiResponse> deleteProductImage(@PathVariable("product_image_id") Integer product_image_id){
        return new ResponseEntity<ApiResponse>(svc.deleteProductImage(product_image_id), HttpStatus.OK);
    }
